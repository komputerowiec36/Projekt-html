<html>
    ...
    <body>
	 <object style="position:absolute top:50px">
        <embed src="online_ski_jumping_k120.swf" width="500" height="400" />
     </object>
   ...
   <?php
     ...
     $result = mysqli_query($con,"SELECT * FROM k120 order by odlegloscp DESC limit 1;");
	 $result2 = mysqli_query($con,"SELECT * FROM k120 order by odlegloscd DESC limit 1;");
