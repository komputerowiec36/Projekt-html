...
if (!$con)
 ...
 $res2 = mysqli_query($con,"Insert into wynikiox SET nick='$wynik', wygrane='1', przegrane='0', remisy='0';");
 }
 
 if(mysqli_num_rows($res) > 0) { 
  $res3 = mysqli_query($con,"SELECT wygrane FROM wynikiox WHERE nick='$wynik';");
  $row = mysqli_fetch_array($res3);
  $wyn = $row['wygrane'] + 1;
  mysqli_query($con, "UPDATE wynikiox SET wygrane='$wyn'");
 }
