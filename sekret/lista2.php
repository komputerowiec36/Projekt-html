...
if (!$con)
 ...
 $res2 = mysqli_query($con,"Insert into wynikiox SET id='1', nick='$wynik', wygrane='0', przegrane='0', remisy='1';");
 }
 
 if(mysqli_num_rows($res) > 0) { 
  $res = mysqli_query($con,"SELECT remisy FROM wynikiox WHERE nick='$wynik';");
  $row = mysqli_fetch_array($res);
  $rem = $row['remisy'] + 1;
  mysqli_query($con, "UPDATE wynikiox SET remisy='$rem'");
 }
